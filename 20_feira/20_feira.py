# 20. Fazer um sistema de Feira Livre que:
# imprima uma lista com as frutas e pedir para o solicitante 
# colocar o nome e selecionar a fruta e depois deve 
# imprimir o nome do solicitante e a fruta usando classes.
...
print("Nossa Feira Livre tem disponível hoje:" #imprime as opções para o usuário
...
for opcao in lista_frutas:
        if opcao_selecionada <= 3:   #verifica a seleção
                print("{}, agradecemos por adquirir a fruta {}.".format(solicitante,lista_frutas[opcao_selecionada].nome_fruta)) #resultado
                print("Volte sempre!")
                break
        if opcao_selecionada >= 4:
                print("{}, nós não temos essa fruta.".format(solicitante))   #caso usuário digite opção inválida
                break