# 13.Fazer uma busca sequencial em uma matriz que:
# Crie uma matriz de 10 linhas e 10 colunas
# e peça para o usuário fazer uma busca.
...
selecao = int(input("Escolha um número de 0 a 99 na matriz {}:".format(matriz))) #busca do usuário
...
for linha in matriz:    #busca nas linhas da matriz
    for coluna in linha:    #busca nas colunas da matriz
        if(coluna == selecao): #comparação da busca do usuário
            print("Encontramos o {} na linha {} e na coluna {}".format(coluna,i,j)) #resultado
            paraloop = True
            break
