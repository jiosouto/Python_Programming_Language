# 01.Fazer um sistema de Feira Livre(Deve imprimir 
...
print(f"Nossa Feira Livre tem disponível hoje: /n[0] laranja , [1] maçã , [2] pera, [3] uva")  #imprime as opções para o usuário 
...
if selecao <= 3:   #verifica a seleção
        ...
        print("Volte sempre!")   
if selecao >= 4:
    print(f"{solicitante}, desculpe, nós não temos essa fruta.")   #caso usuário digite opção inválida

#2ª solução (alternativa de valor)
