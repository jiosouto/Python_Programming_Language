# 16.Fazer um sistema de Agenda de contatos que:
# crie um dicionário com Nome, Telefone e Endereço,
# Imprimir os dados do dicionário, ser capaz de
# inserir e excluir um contato.

#Solucão orientada pelo professor

# usuario = input("Bem-vindo! Digite seu nome:\n")
# lista_agenda = []
...
# Loop infinito
# while True:
#     print("Olá {}, digite o número da opção desejada: ".format(usuario))
#     for opcao in opcoes:
#         print(opcao)
#         instrucao = int(input(""))
#     if instrucao == 1: 
...
#                 indice += 1 
#                 print("Selecione {} para sair...".format(indice))
...
#                         print("Seu item {} foi excluído!".format(item_selecionado)) #Item foi excluído
#                         break #Sai do loop
        ...
        while True:
            ...
            if contador_selecionado.isnumeric():
                ...
                if contador_novo in range(0, contador):
                    ...
                    print("\nO dado da agenda {} foi excluído!\n".format(lista_selecionada)) #Item foi excluído
                    break #Sai do loop
