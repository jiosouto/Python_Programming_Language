# 19. Fazer um sistema de biblioteca que:
# imprima uma lista com 10 livros, armazene o nome do solicitante 
# do empréstimo, disponibilizar e selecionar um livro e 
# imprimir o livro selecionado usando classes.
...
for opcao in lista_livros:    
        ...
        if opcao_selecionada <= 9:     #verifica a seleção
                print("{} o empréstimo do livro {} foi realizado.".format(usuario,lista_livros[opcao_selecionada].emprestimo)) #resultado
                print("Volte sempre!")
                break