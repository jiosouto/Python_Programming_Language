# 21. Usar POO para criar uma agenda
...
while instrucao != 4:
        ...
        while True:
            ...
            if contador_selecionado.isnumeric():
                ...
                if contador_novo in range(0, contador):
                    ...
                    print("\nO dado da agenda {} foi excluído!\n".format(lista_selecionada.nome, lista_selecionada.telefone, lista_selecionada.endereco)) #Item foi excluído
                    break #Sai do loop
    ...
    #imprime a agenda
        ...
        for contato in lista_agenda:
            print("\nContatos da agenda: {}\n".format(contato.nome, contato.telefone, contato.endereco))
