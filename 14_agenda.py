# 14.Fazer um sistema de Agenda de revisão do Carro que: 
# solicite o nome do carro, ano e modelo, nome 
...
print("Bem-vindo a Agenda de revisão de Carros!")
...
while True:
    ...
    if lista == 1:
        ...
        print("Agendamento da revisão do carro: {}\n".format(agenda_carro))   #imprime a agenda
