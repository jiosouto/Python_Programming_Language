# 07.Algoritmo para ligar um carro (Imprimir a sequência para ligar um carro)
# Passo a passo: Coloca a chave no miolo de ignição, Segurar embragem, verificar 
# cambio ponto morto e girar a chave.

print("Bem-vindo ao ligue o seu carro!")
#Passo1
