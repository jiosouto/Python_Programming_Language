# 10.Fazer um sistema de biblioteca que:
# deve imprimir uma lista com 10 livros, pedir o nome do 
# solicitante do empréstimo, pedir para selecionar 
# um livro e imprimir o livro selecionado.

# Orientação do professor: a lista é de strings, você vai colocar 
...
# lista de livros, bibliotecas usam número de registro para identificar cada publicação
    
print("Bem-vindo a Biblioteca Gama! Os livros para empréstimo são:"
'''
...
if emprestimo <=9:     #verifica a seleção
     print("{} o empréstimo do livro {} foi realizado.".format(usuario,lista_livros[emprestimo])) #resultado
     print("Volte sempre!")

# segunda solução - alternativa (uso do if, elif, else)
