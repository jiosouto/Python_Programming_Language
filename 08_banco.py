# 08.Algoritmo para ir ao banco para sacar dinheiro 
# Passo ao passo: endereço do banco, transporte para
# chegar ao banco, localizar caixa eletrônico e cartão
# de acesso a conta, digital de confirmação e senha do banco, 
# digite o valor desejado, saque o dinheiro

print("Bem-vindo ao saque o dinheiro no banco!")
#Passo1
...
if usuario_banco == var1:
    print("Parabéns! Você sacou o dinheiro no Banco!")
elif usuario_banco == var2:
