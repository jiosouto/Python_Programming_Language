# 09.Algoritmo para trocar o pneu do carro
# Encontrar um lugar plano, estável e seguro para estacionar e trocar o pneu; 
...
# Retire o pneu furado e coloque-o sob o veículo — caso o macaco venha a ceder, 
# ele amortecerá a queda, diminuindo o risco de acidentes.
# Ponha o estepe no eixo e aperte os parafusos à mão até onde puder. 
# Ao abaixar o carro, não permita que o peso fique apoiado no novo pneu,
# termine de descer o carro e retire o macaco.
# Coloque o antigo pneu no porta-malas e leve-o ao borracheiro.

print("Bem-vindo ao troque o pneu do seu carro!")
