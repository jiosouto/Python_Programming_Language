# 12.Fazer uma busca sequencial em uma lista 
# (Criar uma tupla [0....20] e pedir para o usuário fazer uma busca)
...
while busca <= 20:
    if num_usuario in tupla:    #condição para buscar o número do usuário na tupla
        ...
        print("O indíce do número {} é {}".format(num_usuario,tupla.index(num_usuario)))    
        paraloop = True
        break
...
# segunda solução com função (alternativa)
